...
((t, e) => {
    ...
    var a, X = function () {
        ...
        i = ('undefined' != typeof window && (window.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = Array.prototype.forEach), 'function' != typeof window.CustomEvent) && (window.CustomEvent = function (t, e) {
            e = e || {bubbles: !1, cancelable: !1, detail: null};
            var n = document.createEvent('CustomEvent');
            return n.initCustomEvent(t, e.bubbles, e.cancelable, e.detail), n;
        }), 'undefined' != typeof document && !!document.documentMode);
    var c = ['webkit', 'moz', 'ms'], l = {};
    ...
    function I(t, e) {
        if (e.touches) {
            ...
            -1 < (n = G(t, e)) && t.splice(n, 1), t.push(e);
        }
    }
    ...
    var q = {
        ...
        setTransform: function (t, e, n) {
            var o = e.x, r = e.y, a = e.isSVG;
            C(t, 'transform', 'scale('.concat(e.scale, ') translate(').concat(o, 'px, ').concat(r, 'px)')), a && i && (e = window.getComputedStyle(t).getPropertyValue('transform'), t.setAttribute('transform', e));
        },
        startX: 0,
        startY: 0,
        startScale: 1,
    ...
    function t(u, f) {
        ...
        n.style.overflow = f.overflow, n.style.userSelect = 'none', n.style.touchAction = f.touchAction, (f.canvas ? n : u).style.cursor = f.cursor, u.style.userSelect = 'none', u.style.touchAction = f.touchAction, C(u, 'transformOrigin', 'string' == typeof f.origin ? f.origin : l ? '0 0' : '50% 50%');
        ...
        function y(o, r, t) {
            ...
            return requestAnimationFrame(function () {
                var t, e, n;
                'boolean' == typeof r.animate && (r.animate ? (t = u, e = r, n = Y('transform'), C(t, 'transition', ''.concat(n, ' ').concat(e.duration, 'ms ').concat(e.easing))) : C(u, 'transition', 'none')), r.setTransform(u, a, r), g(o, a, r), g('panzoomchange', a, r);
            }), a;
        }

        function w(t, e, n, o) {
            var r, a, i, c, l, s, d, o = X(X({}, f), o), p = {x: m, y: h, opts: o};
        ...
        function b(t, e) {
            var n, o, r, a, e = X(X({}, f), e), i = {scale: v, opts: e};
            return !e.force && e.disableZoom || (n = f.minScale, o = f.maxScale, e.contain && (a = (e = N(u)).elem.width / v, r = e.elem.height / v, 1 < a) && 1 < r && (a = (e.parent.width - e.parent.border.left - e.parent.border.right) / a, e = (e.parent.height - e.parent.border.top - e.parent.border.bottom) / r, 'inside' === f.contain ? o = Math.min(o, a, e) : 'outside' === f.contain && (n = Math.max(n, a, e))), i.scale = Math.min(Math.max(t, n), o)), i;
        }
        ...
        function S(t, e, n) {
            ...
            if (a.force || !a.disableZoom) {
                return t = e.scale, e = m, o = h, a.focal && (e = ((r = a.focal).x / t - r.x / v + m * t) / t, o = (r.y / t - r.y / v + h * t) / t), r = w(e, o, t, {
                    relative: !1,
                    force: !0,
        ...
        S(f.startScale, {animate: !1, force: !0}), setTimeout(function () {
        ...
        function o(t) {
            ...
            })(t.target, f) || (I(M, t), p = !0, f.handleStartEvent(t), g('panzoomstart', {
                x: r = m,
                y: a = h,
                scale: v,
                isSVG: l,
                originalEvent: t,
            }, f), t = R(M), i = t.clientX, c = t.clientY, s = v, d = W(M));
        }

        function A(t) {
            var e, n, o;
            p && void 0 !== r && void 0 !== a && void 0 !== i && void 0 !== c && (I(M, t), e = R(M), n = 1 < M.length, o = v, n && (0 === d && (d = W(M)), E(o = b((W(M) - d) * f.step / 80 + s).scale, e, {animate: !1}, t)), n && !f.pinchAndPan || x(r + (e.clientX - i) / o, a + (e.clientY - c) / o, {animate: !1}, t));
        }
        ...
        function z() {
            O || (O = !0, L('down', f.canvas ? n : u, o), L('move', document, A, {passive: !0}), L('up', document, P, {passive: !0}));
        }

        return f.noBind || z(), {
            bind: z, destroy: function () {
                O = !1, V('down', f.canvas ? n : u, o), V('move', document, A), V('up', document, P);
            }, eventNames: T, getPan: function () {
                return {x: m, y: h};
            }, getScale: function () {
                return v;
            }, getOptions: function () {
                ...
                return n;
            }, handleDown: o, handleMove: A, handleUp: P, pan: x, reset: function (t) {
                var t = X(X(X({}, f), {animate: !0, force: !0}), t),
                    e = (v = b(t.startScale, t).scale, w(t.startX, t.startY, v, t));
                return m = e.x, h = e.y, y('panzoomreset', t);
            }, resetStyle: function () {
                n.style.overflow = '', n.style.userSelect = '', n.style.touchAction = '', n.style.cursor = '', u.style.cursor = '', u.style.userSelect = '', u.style.touchAction = '', C(u, 'transformOrigin', '');
                ...
                return e(!1, t);
            }, zoomToPoint: E, zoomWithWheel: function (t, e) {
                t.preventDefault();
                var e = X(X(X({}, f), e), {animate: !1}), n = 0 === t.deltaY && t.deltaX ? t.deltaX : t.deltaY;
